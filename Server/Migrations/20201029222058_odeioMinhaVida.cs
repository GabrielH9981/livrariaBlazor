...
{
    public partial class odeioMinhaVida : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAutors", x => new { x.BookId, x.AutorId });
                    table.ForeignKey(
                        name: "FK_BookAutors_Autors_AutorId",
                        column: x => x.AutorId,
                        principalTable: "Autors",
                        principalColumn: "AutorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookAutors_Books_BookId",
                        column: x => x.BookId,
